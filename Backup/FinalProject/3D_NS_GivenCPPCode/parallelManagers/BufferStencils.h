...
class PressureBufferReadStencil : public BoundaryStencil<FlowField> {
    ...
    public:
        ...
        // Right now, they send an array bigger than necessary, corresponding to the whole face of
        // the flow field, and not only those in the domain. It was easier to program that way.
